...
export function RegisterPage() {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      ...
      setError(requestError.response?.data?.error?.message ?? "Регистрация не удалась. Попробуйте снова.");
    }
  };
  ...
  return (
    <main style={styles.page}>
      <section style={styles.card}>
        ...
        <p style={styles.subtitle}>Заполните данные, чтобы начать работу с платформой AutoGo.</p>
